...
public class CropImageView extends FrameLayout {
    ...
    /**
     * callback to be invoked when image async cropping is complete (saveCity to uri)
     */
    @Deprecated
...
//            throw new IllegalArgumentException("mOnCropImageCompleteListener is not set");
     ...
     * The result will be invoked to listener set by {@link #setOnGetCroppedImageCompleteListener(OnGetCroppedImageCompleteListener)}.
     *
     * @param saveUri the Android Uri to saveCity the cropped image to
     */
    public void saveCroppedImageAsync(Uri saveUri) {
        saveCroppedImageAsync(saveUri, Bitmap.CompressFormat.JPEG, 87, 0, 0, RequestSizeOptions.NONE);
    }
    ...
    /**
     * Set the callback to be invoked when image async saveCity cropping image ({@link #saveCroppedImageAsync(Uri)})
     * is complete (successful or failed).
     *
     * @deprecated use {@link #setOnCropImageCompleteListener(OnCropImageCompleteListener)}.
     */
     ...
     * @param saveUri optional: to saveCity the cropped image to
    ...
    public static class CropResult {
         ...
         * Null if saveCity cropped image was executed, no output requested or failure.
         */
