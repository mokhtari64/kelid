...
public final class CropImage {
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, CharSequence title, boolean includeDocuments) {
        ...
        // Create a chooser from the crop_activity_menu  intent
    ...
    public static List<Intent> getCameraIntents(@NonNull Context context, @NonNull PackageManager packageManager) {
        ...
        // Determine Uri of camera image to  saveCity.
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * the Android Uri to saveCity the cropped image to.<br>
        ...
        /**
         * if the result of crop image activity should not saveCity the cropped image bitmap.<br>
