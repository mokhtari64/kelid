...
public class PaintUtil {
     ...
     */
    public static Paint newGuidelinePaint(@NonNull Context resources) {

        final Paint paint = new Paint();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(resources.getResources().getDimension(R.dimen.guideline_thickness));
        paint.setColor(ContextCompat.getColor(resources,R.color.guideline));
